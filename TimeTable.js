   ...
   var time5=createElement("h5");
    ...
    this.input35.show();
        ...
        this.submit.mousePressed(()=>{
            ...
            user.answer.push(this.input1.value(),this.input2.value(),this.input3.value(),this.input4.value(),this.input5.value(),this.input6.value(),this.input7.value());
            
            user.answer.push(this.input8.value(),this.input9.value(),this.input10.value(),this.input11.value(),this.input12.value(),this.input13.value(),this.input14.value());

            user.answer.push(this.input15.value(),this.input16.value(),this.input17.value(),this.input18.value(),this.input19.value(),this.input20.value(),this.input21.value());

            user.answer.push(this.input22.value(),this.input23.value(),this.input24.value(),this.input25.value(),this.input26.value(),this.input27.value(),this.input28.value());

            user.answer.push(this.input29.value(),this.input30.value(),this.input31.value(),this.input32.value(),this.input33.value(),this.input34.value(),this.input35.value());
